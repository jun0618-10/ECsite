                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="container px-5 mx-auto">
                        ...
                        <div class="-m-2">
                            ...
                            <button type="buttom" onclick="location.href='{{ route('admin.owners.index') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
